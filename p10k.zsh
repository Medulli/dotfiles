...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='ζ'
  ...
  # typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%f𝝉'
  # typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%12F𝛿'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%12F❯ '
